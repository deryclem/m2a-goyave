  ...
  <div class="site-info">
    <div class="site-info">
        <!-- It’s there for you to use if you want to add credit text/links via your child theme -->
                ...
                <a href="http://wordpress.org/" title="<?php esc_attr_e( 'Une plate-forme sémantique de publication personnelle', 'didactique' ); ?>" rel="generator"><?php printf( __( 'Réalisé avec %s', 'didactique' ), 'WordPress' ); ?></a>
                <span class="sep"> | </span>
